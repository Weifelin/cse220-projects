...
decodedLength_input: .asciiz "*a4ZZZYY*b10X*c9W"	
...
runLengthDecode_input: .asciiz "*T4"
runLengthDecode_output: .asciiz "????????????????????"
.align 2
runLengthDecode_outputSize: .word 15
runLengthDecode_runFlag: .ascii "*"

# encodedLength
encodedLength_header: .asciiz "\n\n********* encodedLength *********\n"
encodedLength_input: .asciiz "xxhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhuuunnnnnnnrere"
